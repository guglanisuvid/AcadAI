...
const CreateDiscussionModal = ({ isOpen, onClose, classId, onSuccess }) => {
    ...
    const handleCreateDiscussion = async () => {
        ...
        try {
            ...
            const response = await fetch(`${API_URL}/api/discussions/create`, {
                method: "POST",
                headers: {
                ...
                <form onSubmit={(e) => {
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="mt-1 block w-full rounded-md resize-none border-2 border-gray-300 shadow-sm focus:border-blue-500 focus:ring-0 sm:text-sm transition-colors duration-200 px-2 py-2 outline-none"
                            rows={3}
