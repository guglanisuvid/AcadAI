...
const EditNotesTitleModal = ({ isOpen, onClose, note, onNotesUpdate }) => {
    ...
    const handleEditTitle = async () => {
        ...
        try {
            ...
            const response = await fetch(`${API_URL}/api/notes/${note?._id}/edit-title`, {
                method: "PUT",
                headers: {
...
export default EditNotesTitleModal;